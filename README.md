...
For essentially all purposes, including selfplay game generation and match play, we highly recommend using the latest `release/version` branch (for example `release/0.21`), which is equivalent to using the latest version tag.
 ...
 * Download https://github.com/LeelaChessZero/lc0/archive/release/0.21.zip ([.tar.gz](https://github.com/LeelaChessZero/lc0/archive/release/0.21.tar.gz) archive is also available)
 * Extract
