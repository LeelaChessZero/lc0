...
const OptionId kForceBf16{"force-bf16", "",
                          "Ignore missing bf16 support in ONNX operators."};
...
void ConvertLeelaToOnnx() {
  ...
  if (weights_file.has_onnx_model()) {
    ...
    onnx_options.force_bf16 = dict.Get<bool>(kForceBf16);
