...
template class GlobalAvgPoolLayer<half>;
template class GlobalAvgPoolLayer<float>;

template class GlobalScaleLayer<half>;
template class GlobalScaleLayer<float>;
