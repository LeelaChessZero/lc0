...
static void LoadQuantizationData(MatMulQuantizationData& data,
                                 const half* weights, int input_len,
                                 int output_len,
...
static void LoadQKVQuantizationData(MatMulQuantizationData& data,
                                    const half* qkv_weights, int input_len,
                                    int output_len,
