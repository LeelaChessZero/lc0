...
namespace lczero {
  ...
  void
  Convolution<filter_size>::Forward(const int batch_size, const int input_channels,
  ...
  template <unsigned int filter_size>
  void
  Convolution<filter_size>::Im2Col(const int channels, const float* data_im,
                          float* data_col) {
  ...
  template <>
  void
  Convolution<1>::Im2Col(const int channels, const float* input,
                             float* output) {
  ...
  template <>
  void
  Convolution<1>::Forward(const int batch_size, const int input_channels,
                               const int output_channels, const float* input,
                               const float* weights, const float* biases,
                               float* output) {
    for (int i = 0; i < batch_size; i++) {
