...
TEST(EncodePositionForNN, EncodeFiftyMoveCounter) {
  ...
  // 1. Nf3
  history.Append((history.Last().GetBoard().ParseMove("g1f3", true));
  ...
  // 1. Nf3 Nf6
  history.Append(history.Last().GetBoard().ParseMove("g8f6", true));
...
TEST(EncodePositionForNN, EncodeFiftyMoveCounterFormat3) {
  ...
  // 1. Nf3
  history.Append(history.Last().GetBoard().ParseMove("g1f3", false));
...
TEST(EncodePositionForNN, EncodeEnpassantFormat3) {
  ...
  history.Reset(board, 0, 1);
  // Move to en passant.
  history.Append(history.Last().GetBoard().ParseMove("e2e4", false));
  history.Append(history.Last().GetBoard().ParseMove("g2g3", false));
  history.Append(history.Last().GetBoard().ParseMove("e4e5", false));
  history.Append(history.Last().GetBoard().ParseMove("f2f4", false));
...
TEST(EncodePositionForNN, EncodeEarlyGameFlipFormat3) {
  ...
  history.Append(history.Last().GetBoard().ParseMove("e2e4", false));
  history.Append(history.Last().GetBoard().ParseMove("e2e4", false));
  history.Append(history.Last().GetBoard().ParseMove("e1e2", false));
  history.Append(history.Last().GetBoard().ParseMove("e1e2", false));
  history.Append(history.Last().GetBoard().ParseMove("e2d3", false));
  ...
  history.Append(history.Last().GetBoard().ParseMove("e2e3", false));
