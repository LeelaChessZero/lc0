...
; output                                UAV     f32         buf      U0             u8     1
; input                                 UAV     f32         buf      U1             u9     1
; filter                                UAV     f32         buf      U2            u10     1
; bias                                  UAV     f32         buf      U3            u11     1
;
target datalayout = "e-m:e-p:32:32-i1:32-i8:32-i16:32-i32:32-i64:64-f16:32-f32:32-f64:64-n8:16:32:64"
target triple = "dxil-ms-dx"
...
@"\01?output@@3V?$RWBuffer@M@@A" = external constant %"class.RWBuffer<float>", align 4
@"\01?input@@3V?$RWBuffer@M@@A" = external constant %"class.RWBuffer<float>", align 4
@"\01?filter@@3V?$RWBuffer@M@@A" = external constant %"class.RWBuffer<float>", align 4
@"\01?bias@@3V?$RWBuffer@M@@A" = external constant %"class.RWBuffer<float>", align 4
...
define void @conv_1x1_shader_fp32() {
  %bias_UAV_buf = call %dx.types.Handle @dx.op.createHandle(i32 57, i8 1, i32 3, i32 11, i1 false)  ; CreateHandle(resourceClass,rangeId,index,nonUniformIndex)
  %filter_UAV_buf = call %dx.types.Handle @dx.op.createHandle(i32 57, i8 1, i32 2, i32 10, i1 false)  ; CreateHandle(resourceClass,rangeId,index,nonUniformIndex)
  %input_UAV_buf = call %dx.types.Handle @dx.op.createHandle(i32 57, i8 1, i32 1, i32 9, i1 false)  ; CreateHandle(resourceClass,rangeId,index,nonUniformIndex)
  %output_UAV_buf = call %dx.types.Handle @dx.op.createHandle(i32 57, i8 1, i32 0, i32 8, i1 false)  ; CreateHandle(resourceClass,rangeId,index,nonUniformIndex)
...
; <label>:11                                      ; preds = %9, %5
  ...
  store float %12, float addrspace(3)* @"\01?sh_bias@@3MA", align 4, !tbaa !29
  br label %13
...
; <label>:24                                      ; preds = %18
  %25 = mul i32 %22, %2
  %26 = add i32 %25, %20
  %BufferLoad5 = call %dx.types.ResRet.f32 @dx.op.bufferLoad.f32(i32 68, %dx.types.Handle %filter_UAV_buf, i32 %26, i32 undef)  ; BufferLoad(srv,index,wot)
  %27 = extractvalue %dx.types.ResRet.f32 %BufferLoad5, 0
  %28 = getelementptr [1024 x float], [1024 x float] addrspace(3)* @"\01?sh_filter@@3PAMA", i32 0, i32 %20
  store float %27, float addrspace(3)* %28, align 4, !tbaa !29
  br label %29
...
; <label>:31                                      ; preds = %29
  call void @dx.op.barrier(i32 80, i32 9)  ; Barrier(barrierMode)
  %32 = load float, float addrspace(3)* @"\01?sh_bias@@3MA", align 4, !tbaa !29
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader
  ...
  %40 = shl i32 %39, 6
  %41 = add i32 %40, %1
  %BufferLoad6 = call %dx.types.ResRet.f32 @dx.op.bufferLoad.f32(i32 68, %dx.types.Handle %input_UAV_buf, i32 %41, i32 undef)  ; BufferLoad(srv,index,wot)
  %42 = extractvalue %dx.types.ResRet.f32 %BufferLoad6, 0
  %43 = getelementptr [1024 x float], [1024 x float] addrspace(3)* @"\01?sh_filter@@3PAMA", i32 0, i32 %c1.03
  %44 = load float, float addrspace(3)* %43, align 4, !tbaa !29
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %31
  ...
  %60 = shl i32 %59, 6
  %61 = add i32 %60, %1
  call void @dx.op.bufferStore.f32(i32 69, %dx.types.Handle %output_UAV_buf, i32 %61, i32 undef, float %.op.0, float %.op.0, float %.op.0, float %.op.0, i8 15)  ; BufferStore(uav,coord0,coord1,value0,value1,value2,value3,mask)
  ret void
}
...
!4 = !{null, !5, !11, null}
!5 = !{!6, !8, !9, !10}
!6 = !{i32 0, %"class.RWBuffer<float>"* undef, !"output", i32 0, i32 8, i32 1, i32 10, i1 false, i1 false, i1 false, !7}
!7 = !{i32 0, i32 9}
!8 = !{i32 1, %"class.RWBuffer<float>"* undef, !"input", i32 0, i32 9, i32 1, i32 10, i1 false, i1 false, i1 false, !7}
!9 = !{i32 2, %"class.RWBuffer<float>"* undef, !"filter", i32 0, i32 10, i32 1, i32 10, i1 false, i1 false, i1 false, !7}
!10 = !{i32 3, %"class.RWBuffer<float>"* undef, !"bias", i32 0, i32 11, i32 1, i32 10, i1 false, i1 false, i1 false, !7}
!11 = !{!12}
!12 = !{i32 0, %ConvConsts* undef, !"ConvConsts", i32 0, i32 0, i32 1, i32 20, null}
!13 = !{i32 0, %"class.RWBuffer<float>" undef, !14, %ConvConsts undef, !16}
!14 = !{i32 4, !15}
!15 = !{i32 6, !"h", i32 3, i32 0, i32 7, i32 9}
!16 = !{i32 20, !17, !18, !19, !20, !21}
!17 = !{i32 6, !"N", i32 3, i32 0, i32 7, i32 5}
!18 = !{i32 6, !"K", i32 3, i32 4, i32 7, i32 5}
!19 = !{i32 6, !"C", i32 3, i32 8, i32 7, i32 5}
!20 = !{i32 6, !"useBias", i32 3, i32 12, i32 7, i32 5}
!21 = !{i32 6, !"relu", i32 3, i32 16, i32 7, i32 5}
!22 = !{i32 1, void ()* @conv_1x1_shader_fp32, !23}
!23 = !{!24}
!24 = !{i32 0, !25, !25}
!25 = !{}
!26 = !{void ()* @conv_1x1_shader_fp32, !"conv_1x1_shader_fp32", null, !4, !27}
!27 = !{i32 4, !28}
...
const unsigned char g_conv_1x1_shader_fp32[] = {
  0x44, 0x58, 0x42, 0x43, 0xf3, 0x42, 0x81, 0xa0, 0x97, 0x91, 0xde, 0xe2,
  0x5d, 0xf3, 0x9a, 0xd2, 0x28, 0x28, 0xb5, 0x84, 0x01, 0x00, 0x00, 0x00,
  0xb4, 0x0b, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x34, 0x00, 0x00, 0x00,
  0x44, 0x00, 0x00, 0x00, 0x54, 0x00, 0x00, 0x00, 0x64, 0x00, 0x00, 0x00,
  0xf8, 0x00, 0x00, 0x00, 0x53, 0x46, 0x49, 0x30, 0x08, 0x00, 0x00, 0x00,
  ...
  ,
  ...
  0x80, 0x99, 0x01, 0x00, 0x33, 0x03, 0x00, 0xe6, 0x1c, 0x00, 0x4c, 0x38,
  0x00, 0x98, 0x1f, 0x00, 0xc0, 0x90, 0x47, 0x01, 0x00, 0x00, 0x00, 0x00,
  ...
  0xe4, 0xc9, 0x80, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x60, 0xc8, 0xc3, 0x01, 0x01, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x40, 0x16, 0x08, 0x10, 0x00, 0x00, 0x00, 0x32, 0x1e, 0x98, 0x18,
  0x19, 0x11, 0x4c, 0x90, 0x8c, 0x09, 0x26, 0x47, 0xc6, 0x04, 0x43, 0x02,
  0x47, 0x00, 0x68, 0x1b, 0x01, 0x20, 0xa3, 0x04, 0x8a, 0xa0, 0x10, 0x8a,
  0x61, 0x04, 0xa0, 0x20, 0x8a, 0xa2, 0x24, 0xca, 0xa0, 0x2c, 0x0a, 0xa5,
  0x1c, 0x4a, 0xa1, 0x30, 0x0a, 0xa4, 0x00, 0x03, 0xe8, 0x98, 0x01, 0x20,
  ...
  ,
  ...
  0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x53, 0x82, 0x30, 0xa8, 0x44,
  0x86, 0xe7, 0x42, 0x97, 0x07, 0x57, 0x16, 0xe4, 0xe6, 0xf6, 0x46, 0x17,
  0x46, 0x97, 0xf6, 0xe6, 0x36, 0x37, 0x45, 0xb0, 0x83, 0x3d, 0xa8, 0x43,
  ...
  
};
#if 0
;
...
; <label>:11                                      ; preds = %8
  ...
  %14 = mul i32 %13, %4
  %15 = add i32 %14, %5
  %BufferLoad = call %dx.types.ResRet.f32 @dx.op.bufferLoad.f32(i32 68, %dx.types.Handle %input_UAV_buf, i32 %15, i32 undef)  ; BufferLoad(srv,index,wot)
  %16 = extractvalue %dx.types.ResRet.f32 %BufferLoad, 0
...
!4 = !{null, !5, !10, null}
!5 = !{!6, !8, !9}
!6 = !{i32 0, %"class.RWBuffer<float>"* undef, !"input", i32 0, i32 8, i32 1, i32 10, i1 false, i1 false, i1 false, !7}
!7 = !{i32 0, i32 9}
!8 = !{i32 1, %"class.RWStructuredBuffer<float>"* undef, !"output", i32 0, i32 1, i32 1, i32 12, i1 false, i1 false, i1 false, !2}
!9 = !{i32 2, %"class.RWStructuredBuffer<int>"* undef, !"indices", i32 0, i32 2, i32 1, i32 12, i1 false, i1 false, i1 false, !2}
!10 = !{!11}
!11 = !{i32 0, %PolicyMapConsts* undef, !"PolicyMapConsts", i32 0, i32 0, i32 1, i32 16, null}
!12 = !{i32 0, %"class.RWBuffer<float>" undef, !13, %"class.RWStructuredBuffer<float>" undef, !13, %"class.RWStructuredBuffer<int>" undef, !15, %PolicyMapConsts undef, !17}
!13 = !{i32 4, !14}
!14 = !{i32 6, !"h", i32 3, i32 0, i32 7, i32 9}
!15 = !{i32 4, !16}
!16 = !{i32 6, !"h", i32 3, i32 0, i32 7, i32 4}
!17 = !{i32 16, !18, !19, !20, !21}
!18 = !{i32 6, !"N", i32 3, i32 0, i32 7, i32 5}
!19 = !{i32 6, !"inputSize", i32 3, i32 4, i32 7, i32 5}
!20 = !{i32 6, !"usedSize", i32 3, i32 8, i32 7, i32 5}
!21 = !{i32 6, !"outputSize", i32 3, i32 12, i32 7, i32 5}
!22 = !{i32 1, void ()* @PolicyMapShader, !23}
!23 = !{!24}
!24 = !{i32 0, !25, !25}
!25 = !{}
!26 = !{void ()* @PolicyMapShader, !"PolicyMapShader", null, !4, !27}
...
const unsigned char g_policy_map_shader_fp32[] = {
  0x44, 0x58, 0x42, 0x43, 0xa4, 0x05, 0xae, 0x40, 0x8b, 0x6c, 0x54, 0xe9,
  0x0e, 0x89, 0x72, 0xac, 0xc6, 0xef, 0x83, 0xd3, 0x01, 0x00, 0x00, 0x00,
  0xd0, 0x09, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x34, 0x00, 0x00, 0x00,
  0x44, 0x00, 0x00, 0x00, 0x54, 0x00, 0x00, 0x00, 0x64, 0x00, 0x00, 0x00,
  0xe8, 0x00, 0x00, 0x00, 0x53, 0x46, 0x49, 0x30, 0x08, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x49, 0x53, 0x47, 0x31,
  0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00,
  ...
  0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00,
  0x02, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x44, 0x58, 0x49, 0x4c, 0xe0, 0x08, 0x00, 0x00,
  0x62, 0x00, 0x05, 0x00, 0x38, 0x02, 0x00, 0x00, 0x44, 0x58, 0x49, 0x4c,
  0x02, 0x01, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0xc8, 0x08, 0x00, 0x00,
  0x42, 0x43, 0xc0, 0xde, 0x21, 0x0c, 0x00, 0x00, 0x2f, 0x02, 0x00, 0x00,
  0x0b, 0x82, 0x20, 0x00, 0x02, 0x00, 0x00, 0x00, 0x13, 0x00, 0x00, 0x00,
  0x07, 0x81, 0x23, 0x91, 0x41, 0xc8, 0x04, 0x49, 0x06, 0x10, 0x32, 0x39,
  0x92, 0x01, 0x84, 0x0c, 0x25, 0x05, 0x08, 0x19, 0x1e, 0x04, 0x8b, 0x62,
  0x80, 0x18, 0x45, 0x02, 0x42, 0x92, 0x0b, 0x42, 0xc4, 0x10, 0x32, 0x14,
  ...
  0x32, 0x22, 0x88, 0x09, 0x20, 0x64, 0x85, 0x04, 0x13, 0x23, 0xa4, 0x84,
  0x04, 0x13, 0x23, 0xe3, 0x84, 0xa1, 0x90, 0x14, 0x12, 0x4c, 0x8c, 0x8c,
  0x0b, 0x84, 0xc4, 0x4c, 0x10, 0x8c, 0xc1, 0x0c, 0xc0, 0x4c, 0xd5, 0x38,
  ...
  ,
  ...
  0x00, 0x80, 0x39, 0x03, 0x00, 0xa6, 0x0d, 0x00, 0x98, 0x38, 0x00, 0x80,
  ...
  ,
  ...
  
};
