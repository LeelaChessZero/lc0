...
dxc /Tcs_6_2 /Einput_transform_shader_fp16 /DUSE_FP16_MATH=1 /Fh temp.txt WinogradTransform.hlsl -enable-16bit-types
type temp.txt >> shaders.h
del temp.txt

dxc /Tcs_6_2 /Eoutput_transform_shader_fp16 /DUSE_FP16_MATH=1 /Fh temp.txt WinogradTransform.hlsl -enable-16bit-types
type temp.txt >> shaders.h
del temp.txt
...
dxc /Tcs_6_2 /EPolicyMapShader -Vn g_policy_map_shader_fp16  /DFP16_IO=1 /Fh temp.txt PolicyMap.hlsl -enable-16bit-types
type temp.txt >> shaders.h
del temp.txt
