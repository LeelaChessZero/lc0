...
// The following header is generated by embedder.py,
// it defines a const unsigned char embedded_weights[].
...
WeightsFile LoadEmbeddedWeights() {
  std::string compressed(reinterpret_cast<const char *> (embedded_weights),
                     sizeof (embedded_weights) / sizeof (embedded_weights[0]));
