...
void Benchmark::Run() {
  ...
  options_.Add<StringOption>(kFenId) = ChessBoard::kStartingFen;
  options_.Add<IntOption>(kNNCacheSizeId, 0, 999999999) = 200000;
  options_.Add<IntOption>(kThreadsOptionId, 1, 128) = kDefaultThreads;
