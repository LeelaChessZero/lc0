...
const OptionId SearchParams::kEdgeDiscardFactor{
	...
	"Factor used for discarding thinking time for moves that can not reach bestmoves nodes. Factor of 0.00 is default "
	"higher factors till 1.00 will sooner discard other edges thereby saving time for future moves." };
...
void SearchParams::Populate(OptionsParser* options) {
  ...
  options->Add<FloatOption>(kEdgeDiscardFactor, 0.0f, 1.0f) = 0.0f;
