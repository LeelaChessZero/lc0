...
const OptionId SearchParams::policyLimitId{
    "policy-limit", "PolicyLimit", "how fast policy decays to ."};
...
void SearchParams::Populate(OptionsParser* options) {
  ...
  options->Add<IntOption>(policyDecayId, 1, 100000000) = 2000;
  options->Add<FloatOption>(policyLimitId, 0.01f, 1.0f) = 0.1f;
