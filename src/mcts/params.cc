...
void SearchParams::Populate(OptionsParser* options) {
  ...
  options->Add<FloatOption>(kAprilFactorId, 0.0f, 1.0f) = 0.0012f;
  options->Add<FloatOption>(kCpuctId, 0.0f, 100.0f) = 1.4f;
  options->Add<FloatOption>(kCpuctAtRootId, 0.0f, 100.0f) = 1.4f;
  ...
  options->Add<FloatOption>(kFpuValueId, -100.0f, 100.0f) = 0.14f;
  fpu_strategy.push_back("same");
  options->Add<ChoiceOption>(kFpuStrategyAtRootId, fpu_strategy) = "absolute";
  options->Add<FloatOption>(kFpuValueAtRootId, -100.0f, 100.0f) = 1.0f;
  options->Add<IntOption>(kCacheHistoryLengthId, 0, 7) = 0;
  options->Add<FloatOption>(kPolicySoftmaxTempId, 0.1f, 10.0f) = 1.28f;
