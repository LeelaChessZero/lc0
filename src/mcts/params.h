...
class SearchParams {
 public:
  ...
  float GetPUScale() const { return kPUScale; }
  float GetPUOffset() const { return kPUOffset; }
  ...
  static const OptionId kPUScaleId;
  static const OptionId kPUOffsetId;
 ...
 private:
  ...
  const float kPUScale;
  const float kPUOffset;
};
